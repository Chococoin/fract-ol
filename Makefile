...
#    Updated: 2025/05/13 12:37:58 by glugo-mu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =	src/fractol.c src/utils.c src/utils_2.c  src/utils_3.c src/colours.c \
...
BONUS_SRCS =	bonus/burning.c bonus/hooks.c bonus/fractol.c bonus/draw.c bonus/utils.c \
				src/utils_2.c src/colours.c src/fractals.c src/hooks_utils.c src/draw.c
OBJS = $(SRCS:.c=.o)
